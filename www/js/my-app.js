...
function fetchMovies(searchMovie){
  $.ajax({
    ...
    console.log(data);
     ...
     // Search is the name of the array that holds all of the movies objects
    var output = '';
...
function movieClicked(id){
  sessionStorage.setItem('movieId', id);
    if(movie.Poster == "img/noposter.jpg"){
       var MoviePoster =  "img/noposter.jpg";
    sessionStorage.setItem('movieP0ster', POSter);
    }
}
...
myApp.onPageInit('movie', function (page) {
    var movieId = sessionStorage.getItem('movieId');
     var moviePO = sessionStorage.getItem('movieP0ster');
    getMovie(movieId, moviePO);
